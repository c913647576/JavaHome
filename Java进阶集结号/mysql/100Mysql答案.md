...
### 49.  覆盖索引、回表等这些，了解过吗？
- 覆盖索引： 如果索引的叶子节点包含了要查询的数据，那么久不用回表查询了，也就是说这种索引包含（亦称覆盖）所有需要查询的字段的值，我们称这种索引为覆盖索引。
...
- 组合九：Serializable隔离级别
  ...
  **主键索引和非主键索引的区别**
  ...
  ![ab906bd1b839ae51bc54a472999ce5a6.png](https://img-blog.csdnimg.cn/img_convert/ab906bd1b839ae51bc54a472999ce5a6.png)
